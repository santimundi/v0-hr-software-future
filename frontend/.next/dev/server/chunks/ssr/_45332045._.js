...
function ChatPageContent() {
   ...
   */ const parseBackendResponse = (responseData)=>{
    ...
    const handleSendMessage = async ()=>{
        ...
        setIsLoading(true);
        try {
            // Get persistent user ID (stored in localStorage, consistent across sessions)
            const userId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$user$2d$id$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUserId"])();
...
//# sourceMappingURL=_45332045._.js.map