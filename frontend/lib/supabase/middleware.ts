...
export async function updateSession(request: NextRequest) {
  ...
  console.log("[v0] NEXT_PUBLIC_SUPABASE_URL:", process.env.NEXT_PUBLIC_SUPABASE_URL ? "exists" : "missing")
  console.log("[v0] NEXT_PUBLIC_SUPABASE_ANON_KEY:", process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ? "exists" : "missing")
  console.log("[v0] SUPABASE_URL:", process.env.SUPABASE_URL ? "exists" : "missing")
  console.log("[v0] SUPABASE_ANON_KEY:", process.env.SUPABASE_ANON_KEY ? "exists" : "missing")
